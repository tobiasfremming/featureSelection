...
df = pd.read_csv("../data_sets/diabetes_dataset.csv")
...
pd.to_pickle(totals, "../luts/diabetes.pickle")
pd.DataFrame(totals.items()).to_csv("../luts/diabetes.csv", index=False, header=False)
pd.to_pickle(results, "../luts/diabetes_err.pickle")
pd.DataFrame(results.items()).to_csv("../luts/diabetes_err.csv", index=False, header=False)
pd.to_pickle(penalties, "../luts/diabetes_pen.pickle")
pd.DataFrame(penalties.items()).to_csv("../luts/diabetes_pen.csv", index=False, header=False)